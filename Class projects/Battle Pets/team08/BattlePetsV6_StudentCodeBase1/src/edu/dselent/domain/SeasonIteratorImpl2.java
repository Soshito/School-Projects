...
/**
 * Berger Table
 * TODO is currently just a copy of the Circle method
 */
public class SeasonIteratorImpl2 implements Iterator<Battle>
{
    ...
    public SeasonIteratorImpl2(List<Playable> playableList, Set<Battle> battleSet)
    {
