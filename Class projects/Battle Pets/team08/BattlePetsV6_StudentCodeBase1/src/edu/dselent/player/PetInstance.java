...
public abstract class PetInstance implements Playable
{
	...
	public PetInstance(int playableUid, PlayerSettings playerSettings)
	{
		Player player = new Player(playerSettings.getPlayerName(), playerSettings.getPlayerType());
		pet = new Pet(player, playerSettings.getPetType(), playerSettings.getPetName());

		this.playableUid = playableUid;
		startingHp = playerSettings.getStartingHp();
		...
		Set<Skills> skillSet = playerSettings.getSkillSet();
